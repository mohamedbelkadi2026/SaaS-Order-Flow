...
import { useAllOrders, useUpdateOrderStatus, useAssignAgent, useAgents, useIntegrations, useShipOrder, useUpdateOrder, useBulkAssign, useBulkShip } from "@/hooks/use-store-data";
                      ...
                      {isColVisible('telephone') && (
                        <TableCell className="whitespace-nowrap">
                          <div className="flex items-center gap-1">
                            ...
                            <a href={whatsappLink(order.customerPhone, order.customerName)} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="text-green-500 hover:text-green-700" data-testid={`all-whatsapp-${order.id}`}>
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 mb-1.5">
                    ...
                    <a href={whatsappLink(order.customerPhone, order.customerName)} target="_blank" rel="noopener noreferrer" className="p-1 rounded-full bg-green-100 text-green-600" data-testid={`all-whatsapp-mobile-${order.id}`}>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[80vh] bg-[#f8f9fc] dark:bg-muted/10">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <Input data-testid="all-input-edit-customer-name" value={editFields.customerName} onChange={e => setEditFields(f => ({ ...f, customerName: e.target.value }))} className="bg-white dark:bg-card" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-muted-foreground uppercase">Téléphone</label>
                    <Input data-testid="all-input-edit-customer-phone" value={editFields.customerPhone} onChange={e => setEditFields(f => ({ ...f, customerPhone: e.target.value }))} className="bg-white dark:bg-card" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-muted-foreground uppercase">Adresse</label>
                    <Input data-testid="all-input-edit-customer-address" value={editFields.customerAddress} onChange={e => setEditFields(f => ({ ...f, customerAddress: e.target.value }))} className="bg-white dark:bg-card" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-muted-foreground uppercase">Ville</label>
                    <Input data-testid="all-input-edit-customer-city" value={editFields.customerCity} onChange={e => setEditFields(f => ({ ...f, customerCity: e.target.value }))} className="bg-white dark:bg-card" />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Select defaultValue={selectedOrder.status} onValueChange={(v) => handleStatusChange(selectedOrder.id, v)}>
                      <SelectTrigger className="bg-white dark:bg-card" data-testid="all-select-order-status">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      <SelectTrigger className="bg-white dark:bg-card" data-testid="all-select-order-agent">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input data-testid="all-input-edit-shipping-cost" type="number" step="0.01" value={editFields.shippingCost} onChange={e => setEditFields(f => ({ ...f, shippingCost: e.target.value }))} className="bg-white dark:bg-card" />
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input data-testid="all-input-edit-comment" value={editFields.comment} onChange={e => setEditFields(f => ({ ...f, comment: e.target.value }))} className="bg-white dark:bg-card" />
                  </div>
                  <div className="space-y-1">
              ...
              {hasEdits && (
                <div className="mt-4 flex justify-end">
                  <Button data-testid="all-button-save-order-edits" onClick={handleSaveEdits} disabled={updateOrder.isPending} className="gap-2">
                ...
                <div className="mt-4 bg-muted/30 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex gap-3">
                    <Select value={shippingProvider} onValueChange={setShippingProvider}>
                      <SelectTrigger className="flex-1 bg-white dark:bg-card" data-testid="all-select-shipping-provider">
                    ...
                    <Button data-testid="all-button-ship-order" className="bg-indigo-500 hover:bg-indigo-600 text-white" disabled={!shippingProvider || shipOrder.isPending}
                      onClick={() => {
              ...
              <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-2">
                <Button data-testid="all-button-confirm-order" className="bg-green-500 hover:bg-green-600 text-white text-xs sm:text-sm" onClick={() => handleStatusChange(selectedOrder.id, 'confirme')} disabled={updateStatus.isPending}>
                  Confirmer
                </Button>
