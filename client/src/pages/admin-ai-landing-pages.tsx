    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div className="rounded-2xl border border-white/10 bg-[#162847] p-5 space-y-4">
          ...
          <input value={name} onChange={e=>setName(e.target.value)} placeholder="Nom du produit (optionnel — AI analyse la photo)" className="w-full bg-white/5 border border-white/15 rounded-xl px-3 py-2.5"/>
          ...
          <textarea value={description} onChange={e=>setDescription(e.target.value)} placeholder="Description, avantages, cible... (optionnel)" rows={5} className="w-full bg-white/5 border border-white/15 rounded-xl px-3 py-2.5"/>
