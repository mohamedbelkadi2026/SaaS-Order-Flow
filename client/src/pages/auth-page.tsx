...
import { Loader2, Store, Lock, Mail, User, ShieldAlert } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#3b5998] via-[#4a6baf] to-[#2d4373] flex items-center justify-center p-4">
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-4">
          {suspendedMsg && (
            <div className="flex items-start gap-3 bg-red-600/90 backdrop-blur text-white rounded-xl px-4 py-3 shadow-lg" data-testid="alert-suspended">
              <ShieldAlert className="w-5 h-5 shrink-0 mt-0.5" />
              <p className="text-sm font-medium">{suspendedMsg}</p>
            </div>
          )}
